...
from Cotacao c inner join Media_Diaria m10 on c.Codigo = m10.Codigo and c.Data = m10.Data and m10.Tipo = 'MMA' AND M10.NumPeriodos = 10 
...
AND (C.ValorMinimo <= M10.Valor OR C.ValorMinimo <= MM21.Valor)
) p1
inner join 
(
...
on p2.Codigo = ultimo_comprador.Codigo
