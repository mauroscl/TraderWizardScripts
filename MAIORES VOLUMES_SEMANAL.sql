declare @dataAnterior as datetime = '2017-10-2', @dataAtual as datetime = '2017-10-9',
...
P2.percentual_volume as PercentualVolume2, p2.percentual_candle		as PercentualCandle2, 
...
INNER JOIN
(
	SELECT C.Codigo, C.Titulos_Total, C.ValorMinimo, C.ValorMaximo, M21.Valor as MM21, (C.Titulos_Total / M.Valor) as percentual_volume
	,((C.ValorFechamento - C.ValorMinimo) / (C.ValorMaximo - C.ValorMinimo)) as percentual_candle, 
