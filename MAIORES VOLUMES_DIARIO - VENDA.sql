declare @dataAnterior as datetime = '2018-9-4', @dataAtual as datetime = '2018-9-5',
...
AND ABS(ROUND((P2.ValorMinimo  * (1 - P2.Volatilidade * 1.5 / 100) / P2.MM21 - 1) * 100, 3)) / 10 / P2.Volatilidade <= 2.5
