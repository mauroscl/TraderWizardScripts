...
@data1 as date = '2020-4-6', @data2 as date = '2020-4-7', @data3 as date = '2020-4-8'
...
(
	...
	OR (P3.MM21 - P3.ValorMinimo >  P3.ValorMaximo - P3.MM21  )
...
AND (
	...
	(
		...
		p3.Titulos_Total / p2.Titulos_Total >= 1.2
		AND p3.Negocios_Total / p2.Negocios_Total >= 1.2
	)
)
