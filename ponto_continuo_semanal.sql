----SEMANAL
DECLARE @percentualMinimoVolume as float = 0.8, @percentualDesejadoVolume as float = 1.0, @ifr2Maximo as float = 98, @ifr14Maximo as float = 75

--PONTO CONTINIUO (10)
DECLARE @dataInicial as datetime = '2017-11-21', @dataFinal as datetime = '2017-11-27'
